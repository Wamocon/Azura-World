 ...
 *
 * ## Still read-only, and that is stated
 *
 * `PATCH /api/site-management/buyer-pipeline` is a declared write gap (503, names
 * W2-A). There is no stage-transition control here because faking one is
 * forbidden and failing on every press is worse than saying so once.
 */
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <section aria-labelledby="pipeline-board" className="flex flex-col gap-4">
        ...
        <PipelineBoard stages={boardStages} labels={boardLabels} locale={locale} />
      </section>
    </div>
  )
}
